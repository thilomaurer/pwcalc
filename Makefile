...
release: $(DEPS)
	gnome-extensions pack --podir=po --force --extra-source=utils.js --extra-source=pwcalc-settings.ui --extra-source=prefs.css --extra-source=settings-importexport.ui
